...
class Review(TypedDict):
    ...
    pros: Annotated[Optional[list[str]], "Write down the pros mentioned in the review, if any"] 
    cons: Annotated[Optional[list[str]], "Write down the cons mentioned in the review, if any"]
